...
(function(e) {
	e.backgroundVideo = function(t, n) {
		...
		var o = function() {
			...
			t += 'style="display:none;position:absolute;top:0;left:0;bottom:0;right:0;z-index:1; opacity:0.25;width:100%;height:100%;">';
			t += '<source src="'+jQuery('#bg-video').val()+'" />'
 ...
 jQuery(document).ready(function($) {
    var videobackground = new $.backgroundVideo($('#headerbackground'), {
      "align": "centerXY",
      "width": 1280,
      "height": 720,
      "path": "media/",
