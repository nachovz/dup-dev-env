    ...
    if ( ! class_exists( 'Redux_import_export' ) ) {
        ...
        class Redux_import_export {
            ...
            public function render() {
                ...
                echo '<h4>' . __( 'Select Demo', 'redux-framework' ) . '</h4>';
                echo '<p><a href="javascript:void(0);" style="display: none;" id="redux-import-code-button" class="button-secondary">' . __( 'Import from file', 'redux-framework' ) . '</a> <a href="javascript:void(0);" id="redux-import-link-button" style="display: none;" class="button-secondary">' . __( 'Import from URL', 'redux-framework' ) . '</a></p>';
                ...
                echo '<h4 class="description" id="import-code-description">' . apply_filters( 'redux-import-file-description', __( 'Or import theme settings', 'redux-framework' ) ) . '</h4>';
