...
<div id="posts-content"  class="container" >
   ...
   <section id="posts-content"  class="container" >
      <h2 class="section-heading"><?php _e( 'Nothing Found', 'keysoft' ); ?></h2>
      <span class="separator"></span>
      <?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
      <p  class="section-subheading"><?php printf( esc_html__( 'Ready to publish your first post?', 'keysoft' ), esc_url( admin_url( 'post-new.php' ) ) ); ?></p>
      <?php elseif ( is_search() ) : ?>
      <p  class="section-subheading"><?php _e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'keysoft' ); ?></p>
      <?php get_search_form(); ?>
      <?php else : ?>
      <p  class="section-subheading"><?php _e( 'It seems we can&rsquo;t find what you&rsquo;re looking for. Perhaps searching can help.', 'keysoft' ); ?></p>
      <?php get_search_form(); ?>
      <?php endif; ?>
   </section>
   <?php endif; ?>
